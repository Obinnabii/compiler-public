...
public class IRParser extends java_cup.runtime.lr_parser {
  ...
  @Deprecated
  public IRParser(java_cup.runtime.Scanner s) {
    super(s);
  }

  /** Constructor which sets the default scanner and a SymbolFactory. */
  public IRParser(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {
    super(s, sf);
  }
  ...
  class CUP$IRParser$actions {
    ...
    public final java_cup.runtime.Symbol CUP$IRParser$do_action_part00000000(
      ...
      switch (CUP$IRParser$act_num) {
        ...
        case 0: // $START ::= compunit EOF
          {
            Object RESULT = null;
            IRCompUnit start_val =
                CUP$IRParser$stack.elementAt(CUP$IRParser$top - 1).<IRCompUnit>value();
            RESULT = start_val;
        ...
        case 1: // compunit ::= LPAREN COMPUNIT name ctor_list data_list funcdecls RPAREN
          {
            ...
            List<String> c_list =
                CUP$IRParser$stack.elementAt(CUP$IRParser$top - 3).<List<String>>value();
            List<IRData> d_list =
                CUP$IRParser$stack.elementAt(CUP$IRParser$top - 2).<List<IRData>>value();
            List<IRFuncDecl> f =
                CUP$IRParser$stack.elementAt(CUP$IRParser$top - 1).<List<IRFuncDecl>>value();

            RESULT = parser.nf.IRCompUnit(n);
            for (String ctor : c_list) RESULT.appendCtor(ctor);
            for (IRData data : d_list) RESULT.appendData(data);
            for (IRFuncDecl fd : f) RESULT.appendFunc(fd);
        ...
        case 4: // ctor_list_non_empty ::= name
          {
            ...
            CUP$IRParser$result =
                parser.getSymbolFactory().newSymbol("ctor_list_non_empty", 9, RESULT);
          }
          return CUP$IRParser$result;
        ...
        case 5: // ctor_list_non_empty ::= ctor_list_non_empty name
          {
            List<String> RESULT = null;
            List<String> c_list =
                CUP$IRParser$stack.elementAt(CUP$IRParser$top - 1).<List<String>>value();
            String c = CUP$IRParser$stack.peek().<String>value();
        ...
        case 8: // data_list_non_empty ::= data
          {
            ...
            CUP$IRParser$result =
                parser.getSymbolFactory().newSymbol("data_list_non_empty", 12, RESULT);
          }
          return CUP$IRParser$result;
        ...
        case 9: // data_list_non_empty ::= data_list_non_empty data
          {
            List<IRData> RESULT = null;
            List<IRData> d_list =
                CUP$IRParser$stack.elementAt(CUP$IRParser$top - 1).<List<IRData>>value();
            IRData d = CUP$IRParser$stack.peek().<IRData>value();
        ...
        case 10: // data ::= DATA ATOM LPAREN number_list RPAREN
          {
            ...
            List<Long> n_list =
                CUP$IRParser$stack.elementAt(CUP$IRParser$top - 1).<List<Long>>value();
        ...
        case 13: // number_list_non_empty ::= num
          {
            ...
            CUP$IRParser$result =
                parser.getSymbolFactory().newSymbol("number_list_non_empty", 15, RESULT);
          }
          return CUP$IRParser$result;
        ...
        case 60: // stmts ::= stmts stmt
          {
            List<IRStmt> RESULT = null;
            List<IRStmt> l =
                CUP$IRParser$stack.elementAt(CUP$IRParser$top - 1).<List<IRStmt>>value();
            IRStmt s = CUP$IRParser$stack.peek().<IRStmt>value();
        ...
        case 64: // exprs ::= exprs expr
          {
            List<IRExpr> RESULT = null;
            List<IRExpr> l =
                CUP$IRParser$stack.elementAt(CUP$IRParser$top - 1).<List<IRExpr>>value();
            IRExpr e = CUP$IRParser$stack.peek().<IRExpr>value();
    ...
    public final java_cup.runtime.Symbol CUP$IRParser$do_action(
      ...
      return CUP$IRParser$do_action_part00000000(
          CUP$IRParser$act_num, CUP$IRParser$parser, CUP$IRParser$stack, CUP$IRParser$top);
    }
  }
}
