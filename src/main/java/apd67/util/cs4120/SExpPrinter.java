...
public interface SExpPrinter extends AutoCloseable {
  ...
  /**
   * Flushes all formatted text to the underlying writer. This method should be called when printing
   * is complete.
   */
  void flush();
   ...
   * It is an error to perform any subsequent operations on the same printer.
   */
  @Override
  void close();
}
